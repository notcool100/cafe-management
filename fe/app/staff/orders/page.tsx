...
import { Order, CreateOrderData, OrderType } from '@/lib/types';
...
export default function StaffOrdersPage() {
  ...
  const [selectedCategory, setSelectedCategory] = useState('Momo');
  const [viewMode, setViewMode] = useState<'menu' | 'live-orders'>('menu');
  ...
  // Fetch orders on component mount and when switching to live orders view
  useEffect(() => {
  ...
  const categories = ['Momo', 'Chowmein', 'Pizza', 'Burger', 'Appetizers', 'Drinks'];
  ...
  const filteredItems = menuItems.filter(item =>
    ...
    (selectedCategory === 'Momo' || item.category === selectedCategory)
  );
        ...
        <div className="flex flex-col lg:flex-row">
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                  ...
                  {isLoadingMenu ? (
                    ...
                    <div className="text-center py-12">
                      ...
                      <p className="text-gray-500">Add menu items to start taking orders</p>
                          ...
                          <div className="bg-white border border-gray-100 rounded-xl p-4 hover:shadow-lg hover:border-gray-200 transition-all duration-300 cursor-pointer">
                            <div className="flex items-center space-x-4">
                              <div className="w-16 h-16 bg-gray-100 rounded-full overflow-hidden flex-shrink-0">
                                <img src={item.image || '/api/placeholder/300/200'} alt={item.name} className="w-full h-full object-cover" />
                              </div>
                              <div className="flex-1">
                                <h3 className="font-semibold text-gray-900 text-lg" style={{ fontFamily: 'Jakarta Sans, sans-serif' }}>{item.name}</h3>
                              ...
                              <div className="flex flex-col items-end space-y-2">
                                ...
                                <button
                                  ...
                                  className="px-6 py-2 border-2 border-green-500 text-green-600 rounded-full font-medium hover:bg-green-500 hover:text-white transition-all duration-200 hover:shadow-lg"
                                >
                                  ADD
                                </button>
                              </div>
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                  ...
                  {isLoadingOrders ? (
                    ...
                    <div className="text-center py-12">
                      ...
                      <p className="text-gray-500">Orders will appear here after customers confirm their purchase</p>
                          ...
                          <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-4">
                              <div className="flex items-center">
                                <div className="w-1 h-8 bg-gradient-to-b from-red-500 to-red-600 rounded-full mr-4 shadow-sm"></div>
                                <div>
                                  <div className="flex items-center space-x-2">
          ...
          <aside className="hidden lg:block w-80 border-l border-gray-200 bg-gray-50">
            <div className="sticky top-24 p-6">
              <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                <h3 className="text-xl font-semibold text-gray-900 mb-6">Cart Summary</h3>
                        ...
                        <div key={index} className="flex items-center justify-between py-2 border-b border-gray-50">
                          ...
                          <div className="flex items-center space-x-2">
                            <button
                              ...
                              className="w-6 h-6 rounded-full border border-gray-300 text-gray-500 hover:bg-gray-100 flex items-center justify-center text-sm"
                            >
                              -
                            </button>
                            <span className="text-sm font-medium text-gray-600 w-4 text-center">{item.quantity}</span>
                            <button
                              onClick={() => updateQuantity(item.id, item.quantity + 1)}
                              className="w-6 h-6 rounded-full border border-gray-300 text-gray-500 hover:bg-gray-100 flex items-center justify-center text-sm"
                            >
