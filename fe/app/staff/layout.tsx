            ...
            <div className="min-h-screen bg-gray-950">
                ...
                <div className="lg:pl-64">
                    ...
                    >
                        ...
                        <aside
                            className={cn(
                                'absolute left-0 top-0 h-full w-72 max-w-[85vw] transform border-r border-gray-800 bg-gray-900 shadow-2xl transition-transform duration-300',
                    ...
                    {/* Top bar for mobile */}
                    <div className="sticky top-0 z-40 lg:hidden bg-gray-900 border-b border-gray-800 px-4 py-3">
